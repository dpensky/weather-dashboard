...
A simple weather dashboard web app built with **Node.js**, **Express**, and the **OpenWeatherMap API**. Search any city and view current weather conditions, including temperature and description.
